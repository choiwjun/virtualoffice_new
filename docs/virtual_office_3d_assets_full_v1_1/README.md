...
- Replaced placeholder character GLBs with visible stylized male/female avatar assets.
- Direct files: `models/characters/CHAR_MALE_001.glb`, `models/characters/CHAR_FEMALE_001.glb`.
- Added `previews/characters/character-contact-sheet.png`.
- Rig status: unrigged T-pose base GLB; use Blender/Mixamo for final skeleton and animation clips.
