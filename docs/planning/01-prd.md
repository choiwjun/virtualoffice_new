...
| **SHOULD** | Events 전용 화면 (전사 일정 허브) | #7 | 시안 반영(D26). MVP는 회의 캘린더로 대체 |
| **COULD** | 모바일 알림 (사내 웹 추가) | #7 | 고도화 #7의 일부 (로드맵 7.4 정합, 2026-07-02) |
| **COULD** | Whiteboard 디지털 협업보드 (실시간 캔버스) | #7+ | 시안 반영(D26). MVP는 물리 화이트보드 프롭 + LiveKit 화면공유로 대체 |
...
| **WON'T** | Files 범용 파일 저장소 | 완성 이후 | 시안 반영(D26). 운영 허브 포지셔닝 밖 — result_url+웹콘솔 대체, 완성 후 재검토 |
