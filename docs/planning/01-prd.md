...
| **COULD** | 모바일 알림 (사내 웹 추가) | 추후 | 고도화 #7의 일부 |
...
- [ ] 팀리더가 3D맵만으로 팀 상태를 이해할 수 있다는 피드백
- [ ] 관리자가 KPI 대시보드에서 평가 자료를 자신감 있게 수집 가능
...
- [ ] 화상회의 음성 지연: **< 200ms (사내망 기준)**
- [ ] 회의록 STT 자동 초안 정확도: 주요 발화자·액션아이템 **누락률 < 5%** — 측정 방법: **테스트 회의 N회의 수동 전사와 대조**
...
- [ ] 분기 인사평가 프로세스가 ERP와의 연동으로 자동화되고, 수동 개입 줄어듦
