...
> 🟦 **D29 피벗(2026-07-12) — 렌더 방식만 재대체(2.5D).** 아래 D27/D28 계열의 "실시간 3D R3F·오프라인렌더·깊이합성" 렌더 서술은 **2.5D 클린플레이트 PNG + DOM 스프라이트 아바타**(`OfficeViewport2D`)로 대체됨. 기능·화면·상호작용·좌표·단일세션·Colyseus 골격은 유효. 정본 = **00-decisions §J(D29)**.
